...
class GalleryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Gallery::with(['category'])->select(sprintf('%s.*', (new Gallery)->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'category', 'image', 'status']);
    ...
    public function create()
    {
        ...
        $categories = GalleryCategory::pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');
