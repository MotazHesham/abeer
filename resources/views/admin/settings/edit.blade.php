        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.settings.update', [$setting->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="needsclick dropzone {{ $errors->has('about_cv') ? 'is-invalid' : '' }}"
                        id="about_cv-dropzone">
                    </div>
        ...
        Dropzone.options.aboutPhotoDropzone = {
            ...
            accept: function(file, done) {
                ...
                img.onload = function() {
                    ...
                    if (img.width > 426 || img.height > 346) {
                        done("Image exceeds the maximum allowed dimensions of 426x346.");
                    } else {
                        done();
                    }
                };
