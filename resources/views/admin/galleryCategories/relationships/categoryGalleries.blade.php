...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-categoryGalleries">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($galleries as $key => $gallery)
                        <tr data-entry-id="{{ $gallery->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $gallery->status ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $gallery->status ? 'checked' : '' }}>
                            </td>
                            <td>
                                @can('gallery_show')
...
@endcan
  ...
  let table = $('.datatable-categoryGalleries:not(.ajaxTable)').DataTable({ buttons: dtButtons })
